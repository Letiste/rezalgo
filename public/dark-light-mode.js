...
const colors = {
  lightMode: {
    ...
    "--memory-bg-color": "hsl(125, 39%, 94%)",
    "--memory-border-color": "hsl(123, 38%, 64%)",
    "--memory-font-color": "hsl(124, 55%, 24%)",
    "--time-bg-color": "hsl(46, 100%, 94%)",
    "--time-border-color": "hsl(46, 100%, 65%)",
    "--time-font-color": "hsl(14, 88%, 40%)",
    "--success-bg-color": "hsl(287deg 75% 84% / 60%)",
    "--success-border-color": "hsl(287deg 56% 71% / 60%)",
    "--success-font-color": "hsl(291deg 47% 30%)",
  ...
  darkMode: {
    ...
    "--memory-bg-color": "hsl(142, 85%, 8%)",
    "--memory-border-color": "hsl(122, 34%, 28%)",
    "--memory-font-color": "hsl(125, 23%, 50%)",
    "--time-bg-color": "hsl(45, 67%, 7%)",
    "--time-border-color": "hsl(45, 53%, 23%)",
    "--time-font-color": "hsl(14, 53%, 54%)",
    "--success-bg-color": "hsl(287deg 75% 14% / 60%)",
    "--success-border-color": "hsl(287deg 56% 29% / 60%)",
    "--success-font-color": "hsl(291deg 47% 71%)",
